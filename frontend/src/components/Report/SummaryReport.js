          ...
          rows: [
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph({ text: `${Math.round(submission.executionMemories / 1024)}`, heading: HeadingLevel.HEADING_4 })],
                }),
              ],
            })
          ]
            ...
            ...submission.details.map((detail, index) => {
              return new TableRow({
                children: [
                  ...
                  new TableCell({
                    children: [new Paragraph({ text: `${Math.round(detail.executionMemories / 1024)}`, heading: HeadingLevel.HEADING_4 })],
                  }),
                ],
              })
            })
