...
import { addNewSubgroupAsync, getSubgroupByIdAsync, subgroupSelector } from '../../../store/reducers/subgroupSlice';
...
const SubgroupNew = () => {
  ...
  const subgroupItem = useSelector(subgroupSelector);
  console.log(subgroupItem);


  useEffect(() => {
    dispatch(getAllGroupsAsync());
    dispatch(getSubgroupByIdAsync(groupId)).then((res) => {
      setSubgroup(res.payload.data);
    });
  }, [dispatch, groupId])
